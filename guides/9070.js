...
module.exports = {
 ...
 "s-470-1000-1105-0": [{"type": "text","sub_type": "message","message":  "jump","message_RU": "" }], 	
 "s-470-1000-1106-0": [{"type": "text","sub_type": "message","message":  'smash',"message_RU": "" }], 	 
 "s-470-1000-1120-0": [{"type": "text","sub_type": "message","message":  'pull',"message_RU": " " }], 	
 "s-470-1000-1114-0": [{"type": "text","sub_type": "message","message":  'spray',"message_RU": "" }], 	
 "s-470-1000-1201-0": [{"type": "text","sub_type": "message","message":  'stun',"message_RU": "" }], 	
 "s-470-1000-1307-0": [{"type": "text","sub_type": "message","message":  'bomb',"message_RU": "" }], 	//炸彈 2人------------判断
 "s-470-1000-2105-0": [{"type": "text","sub_type": "message","message":  'jump',"message_RU": "" }], 
 "s-470-1000-2106-0": [{"type": "text","sub_type": "message","message":  'smash',"message_RU": "" }], 	 
 "s-470-1000-2107-0": [{"type": "text","sub_type": "message","message":  'stun',"message_RU": "" }],
 "s-470-1000-2114-0": [{"type": "text","sub_type": "message","message":  'bomb',"message_RU": "" }],  
 "s-470-1000-3106-0": [{"type": "text","sub_type": "message","message":  '100',"message_RU": " " },  
 ...
 "s-470-1000-3218-0": [{"type": "func","func": skilld_event.bind(null, 218)}],	//假         杀一個----------判断 
  ...
  "qb-470-600-470053": [{"type": "text","sub_type": "message","message_RU": "开始" }], 

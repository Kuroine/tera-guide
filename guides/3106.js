...
module.exports = {
	...
	"s-3106-1000-102-0": [{"type": "func","func": combo_checker}],
	"s-3106-1000-105-0": [{"type": "func","func": combo_cont}],
	
	"s-3106-1000-106-0": [{ "type": "text", "sub_type": "message", "message": "Knockback Spin", "message_RU": "" }],


	//513 stomp indicator?
	"s-3106-1000-513-0": [{ "type": "text", "sub_type": "message", "message": "Plague/Regress", "message_RU": "" }],
	"s-3106-1000-514-0": [{ "type": "text", "sub_type": "message", "message": "Plague/Regress", "message_RU": "" }],
